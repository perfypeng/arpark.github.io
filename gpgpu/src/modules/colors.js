...
const shaderSourceRGB2BIN = `
  ...
  /**
   * execute color convernt
   * 
   * @param {Strng} name - program name
   * @param {String} shader - GLSL shader source.
   */
 ...
 * @see rgb2ycbcr
*/
filters.rgb2grey = function() {
	execute.call(this, "rgb2grey", shaderSourceRGB2GREY);
}


/**
 * RGB to Glume space tranform
 * @ingroup ColorSpace
 *
 *
 * @par Overview
 * This method implements RGB to lume compoenent from YCbCr @em color-space.
 * 
 * @see rgb2ycbcr
*/
filters.rgb2luma = function() {
 ...
 * @see rgb2ycbcr
*/
filters.ycbcr2rgb = function() {
	execute.call(this, "ycbcr2rgb", shaderSourceYCbCr2RGB);
}

filters.skinMask = function() {
	var gl = this.gl;
...
*/
filters.rgb2bin = function(thresholds) {
	var gl = this.gl;
